...
<head>
    <meta charset="UTF-8">
    <title>XIO's first CodeIgniter</title>
    ...
    <style {csp-style-nonce}>
        ...
        *:focus {
        ...
        header li.menu-item a:focus {
            /* background-color: rgba(221, 72, 20, .2); */
            background-color: rgba(186, 127, 232, .2);
...
<header>
    ...
    <div class="menu">
        <ul>
            <li class="logo"><a href="https://xiocode.com" target="_blank"><img height="44" title="CodeIgniter Logo"
            ...
            <li class="menu-item hidden"><a href="<?= site_url('auth/register')  ?>">註冊</a></li>
            <li class="menu-item hidden"><a href="<?= site_url('auth') ?>">登入</a></li>
        </ul>
    </div>

    <div class="heroe">

        <!-- <h1>Welcome to XIO's first CodeIgniter Project</h1> -->
        <h1>歡迎來到XIO的第一個CodeIgniter專案</h1>
